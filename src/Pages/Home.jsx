        ...
        <div>
            ...
            <div className="container mt-14 mb-12">
                ...
                <div
                    ...
                    <Link
                        to="/products"
                        className="bg-gradient-to-r from-primary to-secondary transition-all duration-200 text-white py-2 px-6 rounded-full hover:scale-105 font-semibold shadow-md text-sm"
                    >
                        View All Products
                    </Link>
                </div>
