                                ...
                                <div
                                    ...
                                    <div className="mt-4">
                                        ...
                                        <div className="flex justify-between items-center">
                                            ...
                                            <button className="bg-gradient-to-r from-primary to-secondary transition-all duration-200 text-white py-1.5 px-4 rounded-full hover:scale-105 text-sm font-semibold shadow-sm">
                                                Order Now
                                            </button>
                                        </div>
                                    </div>
